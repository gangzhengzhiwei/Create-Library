...
public class PetrolparkLootEntityNumberProviderTypes {
    ...
    public static final RegistryEntry<LootEntityNumberProviderType> EQUIPMENT = REGISTRATE.lootEntityNumberProviderType("equipment", new EquipmentNumberProvider.Serializer());
